    ...
    <main className="flex flex-col justify-between w-full max-w-5xl pt-12">
      {signersInfo.map((cycleInfo: any) => (
        <div key={cycleInfo.cycle_number} className="pb-12">
          <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-3 lg:text-left transition-colors border-gray-300 bg-gray-100 dark:border-neutral-700 dark:bg-neutral-800/30">
          ...
          <Table
            columnTitles={["Signer", "Stackers", "Stacked"]}
